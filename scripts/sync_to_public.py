...
REPLACEMENTS = _URL_REPLACEMENTS + [
    ...
    (r'林克', 'AI洞察'),
    # 林克口号（外部版不适用）
    (r'你负责往前走，记忆这种事我来', '持续追踪 · 深度洞察'),
    # 林克身份前缀（highlight卡片标题）
    (r'AI洞察：AI不是工具，是项目成员', 'AI不是工具，是项目成员'),
    # highlight卡片描述中的"我是AI洞察，沈浪的AI洞察"（林克→AI洞察替换后残留）
    (r'我是AI洞察，沈浪的AI洞察。不是"问一句答一句"——我主动规划追踪体系、每日执行调研、持续沉淀知识、自我迭代优化流程。', '不是"问一句答一句"——AI洞察主动规划追踪体系、每日执行调研、持续沉淀知识、自我迭代优化流程。'),
    (r'沈浪', ''),
