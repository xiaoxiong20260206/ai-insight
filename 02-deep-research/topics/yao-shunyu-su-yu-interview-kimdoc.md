...
![[封面：两篇访谈揭示AI行业从英雄时代到工程时代的深层收敛](https://placehold.co/980x551/png?text=Image+Unavailable)](https://placehold.co/980x551/png?text=Image+Unavailable)

# 00 全文概览：先说结论
![概览：两篇访谈的核心收敛](https://placehold.co/980x551/png?text=Image+Unavailable)
...
# 01 英雄已死——集体主义的胜利
![从英雄时代到工程时代](https://placehold.co/980x551/png?text=Image+Unavailable)
...
![Agent技术70年收敛弧线](https://placehold.co/980x551/png?text=Image+Unavailable)
...
# 03 专业化智能——百万小世界的专家
![专业化vs通用化](https://placehold.co/980x551/png?text=Image+Unavailable)
...
![中美AI发展模式对比](https://placehold.co/980x551/png?text=Image+Unavailable)
...
![可靠性是AI产品的真正护城河](https://placehold.co/980x551/png?text=Image+Unavailable)
...
# 09 总结：规律·现象·趋势
![总结](https://placehold.co/980x551/png?text=Image+Unavailable)
