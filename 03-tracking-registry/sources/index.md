...
> **版本**: v1.6.0
> **更新时间**: 2026-03-07
> **本次Review重点**: 新增国内AI Coding官方渠道(6个) + 补充新增公司全量微信公众号(15+)
...
| 公司/产品 | URL | 检查频率 | 内容类型 |
|----------|-----|---------|---------|
| **Trae (字节)** | trae.cn | 每日 | 国内首个AI IDE, 产品更新 |
...
| **CodeGeeX (智谱)** | codegeex.cn | 每周2次 | 开源代码模型, 插件更新 |
| **CodeGeeX GitHub** | github.com/THUDM/CodeGeeX | 每周1次 | 开源模型发布, 技术文档 |
| **文心快码 (百度)** | comate.baidu.com | 每周1次 | 企业级AI编程, 文心大模型集成 |
| **豆包MarsCode (字节)** | marscode.cn | 每周1次 | 云IDE, AI编程助手 |
...
| **AI科技大本营** | CSDN旗下 | 每日 | 技术教程、开发者社区、实战案例 |
...
# AI Coding产品 (每日至少查2家) ← 新增
Trae 字节 AI编程 最新
通义灵码 更新 发布
CodeGeeX 智谱 更新
MarsCode 最新 更新
Baidu Comate 百度 编程助手
...
# 中文技术社区 (轮换查2个)
site:juejin.cn AI 人工智能 (今日)     # 稀土掘金
site:zhihu.com AI 大模型 (本周热门)    # 知乎AI话题
site:sspai.com AI (最新)              # 少数派AI频道
site:oschina.net AI (今日)            # 开源中国
...
9. **国内AI Coding产品**（Trae / 通义灵码 / CodeGeeX / MarsCode）至少 **1** 家 ← **新增**
...
*最近更新: 2026-03-08 - 国内搜索策略大幅强化 + 覆盖均衡性规则升级（v1.7.0）*
*- 国内搜索独立分离，三维度覆盖（公司/媒体/开发者社区）*
*- 新增AI Coding国内产品专项搜索*
*- 覆盖均衡性原则从6组→8组，国内从1组→4组*
*- 强制每期日报国内新闻≥3条*
